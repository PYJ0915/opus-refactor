    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/unveiling/**").permitAll()
                        ...
                        .requestMatchers(
                                "/reviews/getReviews", "/reviews/getReviewsCount", "/reviews/count",
                                "/reviews/averageRating", "/reviews/likeCount", "/reviews/averageRatings"
                        ).permitAll()
                        .requestMatchers(
                                "/auth/**", "/stage/like", "/stage/dislike", "/stage/save",
                                "/stage/bestReview", "/stage/cache", "/stage/cache/**"
                        ).permitAll()
                ...
                .oauth2Login(oauth -> oauth
                        ...
                        .failureHandler((request, response, exception) -> {
                            ...
                            response.sendRedirect(redirectUri + "?error=true");
                        }))
